...
class MqttUtil {
    ...
    static subscribeAsync(topic, qos = 0) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = MqttUtil.getInstance();
            return client.subscribeAsync(topic, { qos });
        });
    }
    static publishAsync(topic, message, qos = 0, retain = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = MqttUtil.getInstance();
...
exports.MqttUtil = MqttUtil;
MqttUtil.brokerUrl = "mqtt://hats.hcs.cn";
